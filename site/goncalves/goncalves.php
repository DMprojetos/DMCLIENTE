...
<div class="container mb-4">
    <img src="assets/logogoncalves.png" alt="Logo da Barbearia" class="responsive-image logo-image">
</div>

<div class="container mb-4">
    <img src="assets/valoresgoncalves.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>
...
<div class="custom-modal" id="agendamentoModal">
    ...
    <div class="modal-body">
        <div class="button-container">
            <input type="button" value="Gonçalves" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
        </div>
    </div>
</div>
...
<div class="custom-modal" id="serviceModal">
    ...
    <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
        <div class="d-grid gap-2">
            ...
            <input type="button" value="Pacote cabelo R$00" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Pacote barba R$00" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Pacote cabelo e Barba R$00" class="btn btn-secondary" onclick="selecionarServico(this)">
            ...
            <input type="button" value="Maquina R$30" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Cabelo e Barba R$89,90" class="btn btn-secondary" onclick="selecionarServico(this)">
...
<script>
    ...
    for (let i = 0; i < 7; i++) {
        ...
        // Ignora domingo e o dia atual após as 23h
        if (diaIndex === 0 || (i === 0 && horaAtual >= 23)) {
            continue;
        }

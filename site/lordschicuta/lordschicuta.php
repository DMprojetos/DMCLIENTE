...
body {
    ...
    background-image: url('assets/fundolords.png');
...
<div class="container mb-4">
    <img src="assets/logolordschicuta.png" alt="Logo da Barbearia" class="responsive-image logo-image">
</div>

<div class="container mb-4">
    <img src="assets/valoreslords.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>
...
<div class="custom-modal" id="agendamentoModal">
    ...
    <div class="modal-body">
        <div class="button-container">
            <input type="button" value="Diego paz" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Júlio Neckel" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Michael Fagundes" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
        </div>
    </div>
</div>
...
<div class="modal-body" style="max-height: 400px; overflow-y: auto;">
    <div class="d-grid gap-2">
        ...
        <input type="button" value="Navalhado R$ 45" class="btn btn-secondary" onclick="selecionarServico(this)">
        <input type="button" value="Barba R$ 40" class="btn btn-secondary" onclick="selecionarServico(this)">
        <input type="button" value="Sobrancelha R$ 15" class="btn btn-secondary" onclick="selecionarServico(this)">
        <input type="button" value="Cabelo e Barba R$ 80" class="btn btn-secondary" onclick="selecionarServico(this)">
        <input type="button" value="Club Cabelo R$ 00" class="btn btn-secondary" onclick="selecionarServico(this)">
        <input type="button" value="Club Cabelo e Barba R$ 00" class="btn btn-secondary" onclick="selecionarServico(this)">
    </div>
</div>
...
<body>
<div class="container mb-4">
    <img src="assets/planoslords.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>
...
<script>
    ...
    function selecionarDia(element) {
        ...
        // Verifica se o dia selecionado é sexta ou sábado
        if (diaSelecionado === "Sexta-feira" || diaSelecionado === "Sábado") {
            Swal.fire({
                title: 'Atenção',
                text: 'Horários por ordem de chegada!!',
                icon: 'info',
                confirmButtonText: 'Ok'
            });
            return; // Não carrega os horários
        }
...
function abrirModalHorarios() {
    ...
    // Verifica se o dia selecionado é sexta ou sábado
    if (selectedDay === "Sexta-feira" || selectedDay === "Sábado") {
        Swal.fire({
            title: 'Atenção',
            text: 'Horários não estão disponíveis para sexta-feira e sábado.',
            icon: 'info',
            confirmButtonText: 'Ok'
        }).then(() => {
            // Fechar todos os modais abertos
            fecharModal(); // Fechar o modal de serviços
            fecharModalDias(); // Fechar o modal de dias
            fecharModalHorarios(); // Fechar o modal de horários
            setTimeout(() => {
                window.location.href = window.location.href; // Recarrega a página forçadamente
            }, 100); // Atraso de 100 milissegundos
        });
        return; // Não exibe os horários
    }

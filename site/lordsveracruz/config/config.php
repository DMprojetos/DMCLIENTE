...
$username = "u870367221_lordsveracruz";
$password = "Deividlps120@";
$dbname = "u870367221_lordsveracruz";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['professional'], $_POST['day'])) {
    ...
    if ($dayOfWeek == 1) { // Segunda-feira
        ...
        $timeSlots = [
            ...
            'endMorning' => strtotime("12:00"),
            'startAfternoon' => strtotime("13:30"),
            'endAfternoon' => strtotime("20:00")
        ];
    } elseif ($dayOfWeek == 6) { // Sábado
        $timeSlots = [
            'startMorning' => strtotime("09:00"),
            'endMorning' => strtotime("18:00"),
            'startAfternoon' => null,
            'endAfternoon' => null
        ];

...
body {
    ...
    background-image: url('assets/fotofundotelles.png');
...
<div class="container mb-4">
    <img src="assets/logotelles.png" alt="Logo da Barbearia" class="responsive-image logo-image">
</div>

<div class="container mb-4">
    <img src="assets/valorestelles.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>
...
<div class="custom-modal" id="agendamentoModal">
    ...
    <div class="modal-body">
        <div class="button-container">
            <input type="button" value="Telles" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
        </div>
    </div>
</div>
...
<div class="custom-modal" id="serviceModal">
    ...
    <!-- Serviços Masculinos -->
    <h4 style="color: black;">Serviços oferecidos</h4>
    <input type="button" value="Plano Mensal R$00" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Cabelo R$35" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Barba R$25" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Sobrancelha R$10" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Cabelo e Barba R$55" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Cabelo, Sobrancelha e Barba R$60" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Cabelo e Sobrancelha R$45" class="btn btn-secondary" onclick="selecionarServico(this)">
    <input type="button" value="Sobrancelha e Barba R$35" class="btn btn-secondary" onclick="selecionarServico(this)">
</div>
...
function abrirModalHorarios() {
    ...
    .then(data => {
        ...
        if (data.message) {
            // Caso seja sexta ou sábado, exibe a mensagem de ordem de chegada
            Swal.fire({
                title: 'Informação',
                text: data.message,
                icon: 'info',
...
<div class="container mb-4">
    <img src="assets/planostelles.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>

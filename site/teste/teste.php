...
<div class="container mb-4">
    <img src="assets/logolordsveracruz.png" alt="Logo da Barbearia" class="responsive-image logo-image">
</div>
...
<div class="custom-modal" id="agendamentoModal">
    ...
    <div class="modal-body">
        <div class="button-container">
            <input type="button" value="Jean Alves" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Yasmim Goulart" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Guilherme Borges" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
        </div>
    </div>
</div>
...
<div class="modal-body" style="max-height: 400px; overflow-y: auto;">
    <div class="d-grid gap-2">
        ...
        <input type="button" value="Club Família R$ 00" class="btn btn-secondary" onclick="selecionarServico(this)">
    </div>
</div>

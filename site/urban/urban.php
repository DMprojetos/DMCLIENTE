...
<div class="container mb-4">
    <img src="assets/logourban.png" alt="Logo da Barbearia" class="responsive-image logo-image">
</div>

<div class="container mb-4">
    <img src="assets/tabelamasc.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>

<div class="container mb-4">
    <img src="assets/tabelafem.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>
...
<div class="custom-modal" id="agendamentoModal">
    ...
    <div class="modal-body">
        <div class="button-container">
            <input type="button" value="Arthur" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Nicolas" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Caetano" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Nunes" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
            <input type="button" value="Moika" class="btn btn-primary m-2" onclick="selecionarProfissional(this)">
        </div>
    </div>
</div>
...
<div class="custom-modal" id="serviceModal">
    ...
    <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
        <div class="d-grid gap-2">
            ...
            <input type="button" value="Sobrancelha R$15" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Limpeza de pele R$30" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Desenho/Freestyle R$10" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Alisamento R$20" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Luzes R$150" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Platinado/Nevou R$160" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Pigmentação R$20" class="btn btn-secondary" onclick="selecionarServico(this)">

            <!-- Serviços Femininos -->
            <h4 style="color: black; margin-top: 20px;">Feminino</h4>
            <input type="button" value="Corte R$70" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Escova R$70" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Hidratação R$50" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Coloração R$65" class="btn btn-secondary" onclick="selecionarServico(this)">
            <input type="button" value="Sobrancelha na cera R$20" class="btn btn-secondary" onclick="selecionarServico(this)">
        </div>
    </div>
...
<div class="container mb-4">
    <img src="assets/promo.png" alt="Tabela de Valores" class="responsive-image values-image">
</div>
...
<script>
    ...
    .then(unavailableHours => {
        ...
        if (!Array.isArray(unavailableHours)) {
            Swal.fire({
                title: 'Erro',
                text: 'Erro ao processar os horários. Por favor, tente novamente.',
                icon: 'error',
        ...
        const horariosDisponiveis = ["09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00"];

        horariosDisponiveis.forEach(horario => {
            if (!unavailableHours.includes(horario)) {
                const btn = document.createElement("input");
                btn.type = "button";
                btn.value = horario;
    ...
    function enviarAgendamento() {
        ...
        fetch("config/config.php", {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
            body: `nome=${encodeURIComponent(nome)}&telefone=${encodeURIComponent(telefone)}&profissional=${encodeURIComponent(profissional)}&servico=${encodeURIComponent(servico)}&dia=${encodeURIComponent(dia)}&horario=${encodeURIComponent(horario)}&horario_final=${encodeURIComponent(horario_final)}&tempo_total=${encodeURIComponent(tempoTotal)}`
        })
